                ...
                <form id='form' action='php/sign-up.php' enctype="multipart/form-data" method="post" class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class='row px-3 location' id="location-container">
                            <label lass="mb-1" for="city"><h6 class="mb-0 text-sm">Location</h6></label>
                            <select id="city" name="location" class='custom-select' ></select>
                        </div>
